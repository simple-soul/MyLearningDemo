...
@DatabaseTable(tableName = "sensorMin")
public class SensorTableMin {
    ...
    public SensorTableMin() {
    }

    public SensorTableMin(int pm25, int co2, int temp, int light, int hum, int status) {
        this.pm25 = pm25;
        this.co2 = co2;
        this.temp = temp;
        this.light = light;
